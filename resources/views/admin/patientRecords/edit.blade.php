    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patient-records.update", [$patientRecord->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_1') ? 'is-invalid' : '' }}" type="text" name="pi_1" id="pi_1" value="{{ old('pi_1', $patientRecord->pi_1) }}" required>
                @if($errors->has('pi_1'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department" id="department" required>
                    ...
                    @foreach(App\Models\PatientRecord::DEPARTMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('department', $patientRecord->department) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('state_status') ? 'is-invalid' : '' }}" name="state_status" id="state_status" required>
                    ...
                    @foreach(App\Models\PatientRecord::STATE_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('state_status', $patientRecord->state_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" name="position" id="position" required>
                    ...
                    @foreach(App\Models\PatientRecord::POSITION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('position', $patientRecord->position) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" name="unit" id="unit" required>
                    ...
                    @foreach(App\Models\PatientRecord::UNIT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('unit', $patientRecord->unit) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('unit'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employment_info') ? 'is-invalid' : '' }}" type="text" name="employment_info" id="employment_info" value="{{ old('employment_info', $patientRecord->employment_info) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blood_pressure') ? 'is-invalid' : '' }}" type="text" name="blood_pressure" id="blood_pressure" value="{{ old('blood_pressure', $patientRecord->blood_pressure) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('heart_rate') ? 'is-invalid' : '' }}" type="text" name="heart_rate" id="heart_rate" value="{{ old('heart_rate', $patientRecord->heart_rate) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('temperature') ? 'is-invalid' : '' }}" type="text" name="temperature" id="temperature" value="{{ old('temperature', $patientRecord->temperature) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('med_name') ? 'is-invalid' : '' }}" type="text" name="med_name" id="med_name" value="{{ old('med_name', $patientRecord->med_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('action_taken') ? 'is-invalid' : '' }}" type="text" name="action_taken" id="action_taken" value="{{ old('action_taken', $patientRecord->action_taken) }}" required>
